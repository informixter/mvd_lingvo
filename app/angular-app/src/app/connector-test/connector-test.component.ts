...
@Component({
	selector: 'app-connector-test',
	templateUrl: './connector-test.component.html',
	styleUrls: ['./connector-test.component.scss']
})
export class ConnectorTestComponent implements OnInit
{
