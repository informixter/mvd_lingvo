...
#build_test:
#	docker build -f=DockerfileElectron ./test-app/ -t electron-app
#	docker run --rm --entrypoint cat electron-app /app/out/make/deb/x64/mvd.linngvoprocessor.test_1.0.0_amd64.deb > ./deb/app.deb
